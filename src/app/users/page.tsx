...
const page = () => {
  return (
    ...
    <div className="bg-white shadow-lg p-4 rounded col-span-1 row-span-2">Card 4</div>
    <div className="bg-white shadow-lg p-4 rounded col-span-2 row-span-2">Card 5</div>
    <div className="bg-white shadow-lg p-4 rounded col-span-2 row-span-4">Card 6</div>
